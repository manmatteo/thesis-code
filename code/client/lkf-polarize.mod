...
polarize_tseitin t+ t+.
polarize_tseitin f- f-.
polarize_tseitin f+ f+.
polarize_tseitin t- t-.
polarize_tseitin (B &&- C) (d+ (B' &&- C')) :- polarize_tseitin B B', polarize_tseitin C C'.
polarize_tseitin (B ||- C) (d+ (B' ||- C')) :- polarize_tseitin B B', polarize_tseitin C C'.
polarize_tseitin (B &&+ C) (d- (B' &&+ C')) :- polarize_tseitin B B', polarize_tseitin C C'.
polarize_tseitin (B ||+ C) (d- (B' ||+ C')) :- polarize_tseitin B B', polarize_tseitin C C'.
polarize_tseitin (n A) (n A) :- atomic A.
polarize_tseitin (p A) (p A) :- atomic A.

polarize_tseitin (some B) (some B')  :-    pi x\ polarize_tseitin (B x) (B' x).
polarize_tseitin (all B) (d+ (all B'))  :- pi x\ polarize_tseitin (B x) (B' x).